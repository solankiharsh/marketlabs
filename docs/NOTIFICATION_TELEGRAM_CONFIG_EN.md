...
> Zing supports real-time strategy signal notifications via Telegram Bot.
...
3. Enter a display name for your bot (e.g., `Zing Signal Bot`)
4. Choose a unique username ending with `bot` (e.g., `qd_signal_bot`)
