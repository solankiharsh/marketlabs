...
Zing is a **local-first, self-hosted quantitative trading system**.
...
Zing is under active development.
...
or commit when running Zing in production environments.

---

## 🧠 Security Model & Scope

Zing is designed to run **entirely under the user's control**.

### In Scope
We consider the following areas in scope for security review:

- Source code vulnerabilities in this repository
- Authentication and authorization logic within Zing
...
- Modified or unofficial builds of Zing

---

## 📣 Reporting a Vulnerability

If you believe you have found a security vulnerability in Zing,
...
Zing is provided **as-is**, without warranty.
...
Thank you for helping keep Zing safe.
