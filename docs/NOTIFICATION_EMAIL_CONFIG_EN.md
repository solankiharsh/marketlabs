...
> Zing supports strategy signal notifications via email, ideal for users who need detailed notification records.
...
- Zing backend service deployed and running

---

## Supported Email Providers

Zing supports any standard SMTP protocol email provider, including:
...
Add SMTP parameters to your `server/.env` file:
...
Yes, Zing automatically sends formatted HTML emails with a plain text fallback for maximum compatibility.
