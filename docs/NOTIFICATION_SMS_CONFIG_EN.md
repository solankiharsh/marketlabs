...
> Zing supports SMS notifications via Twilio, ensuring you receive critical trading signals anywhere.
...
Add Twilio parameters to your `server/.env` file:
...
Zing currently only supports Twilio as the SMS provider. For other services, use the Webhook channel to integrate:
- Nexmo (Vonage)
- AWS SNS
- MessageBird
- Plivo
